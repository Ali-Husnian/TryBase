...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " ").concat(loc.description, "<p/>")).addTo(map); // Add map bound to include current location
...
var stripe = Stripe('pk_test_51OI7wKFW4AE5jwYD35PfpvbXYZzUtooP4l9npEHGCHQt5iLNcqDTbAHZRJ5szVhEFYTO052jM4YD6PJTnNJTaG3S001aIIGIo1');
